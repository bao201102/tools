...
export const translations = {
  en: {
    ...
    'tool.jsonToExcel.jsonInputLabel': 'JSON Input (array of objects)',
    'tool.jsonToExcel.previewLabel': 'Preview (first 5 rows)',
    'tool.jsonToExcel.previewPlaceholder': 'Click "Preview" to see table structure',
    'tool.jsonToExcel.sheetName': 'Sheet name:',
    'tool.jsonToExcel.flattenNested': 'Flatten nested objects',
    'tool.jsonToExcel.preview': 'Preview',
    'tool.jsonToExcel.downloadExcel': 'Download Excel',
    'tool.jsonToExcel.tip': 'Tip: Your JSON should be an array of objects where each object becomes a row. Nested objects will be flattened to dot notation (e.g., address.city).',
    'tool.excelToJson.desc': 'Convert Excel spreadsheets to JSON format. Upload a file or paste directly from Excel:',
    'tool.excelToJson.uploadOrPaste': 'Upload or Paste Data',
    'tool.excelToJson.clickToUpload': 'Click to upload Excel file',
    'tool.excelToJson.fileUploaded': 'File uploaded successfully',
    'tool.excelToJson.fileSupports': 'Supports .xlsx, .xls, .csv, .tsv files',
    'tool.excelToJson.orPasteDivider': '— or paste data directly from Excel —',
    'tool.excelToJson.pastePlaceholder': 'Copy cells from Excel and paste here (Ctrl+V / Cmd+V)',
    'tool.excelToJson.convertPasted': 'Convert Pasted Data',
    'tool.excelToJson.jsonOutput': 'JSON Output',
    'tool.excelToJson.jsonOutputPlaceholder': 'JSON output will appear here...',
    'tool.excelToJson.download': 'Download',
    'tool.excelToJson.privacy': 'Privacy: Your file is processed entirely in your browser. No data is uploaded to any server.',
    'page.notFound.title': 'Page Not Found — NUB Portal',
    'page.notFound.heading': 'Page Not Found',
    'page.notFound.pathDesc': 'The path {path} does not exist.',
    ...
    'tool.jwt.expiresAt': 'Expires',
    'tool.jwt.issuedAt': 'Issued',
  ...
  vi: {
    ...
    'tool.jsonToExcel.jsonInputLabel': 'Dữ liệu JSON đầu vào (mảng các đối tượng)',
    'tool.jsonToExcel.previewLabel': 'Xem trước (5 dòng đầu)',
    'tool.jsonToExcel.previewPlaceholder': 'Nhấp vào "Xem trước" để xem cấu trúc bảng',
    'tool.jsonToExcel.sheetName': 'Tên sheet:',
    'tool.jsonToExcel.flattenNested': 'Làm phẳng các đối tượng lồng nhau',
    'tool.jsonToExcel.preview': 'Xem trước',
    'tool.jsonToExcel.downloadExcel': 'Tải xuống Excel',
    'tool.jsonToExcel.tip': 'Gợi ý: JSON của bạn nên là một mảng các đối tượng trong đó mỗi đối tượng sẽ trở thành một dòng. Các đối tượng lồng nhau sẽ được làm phẳng thành ký hiệu dấu chấm (ví dụ: address.city).',
    'tool.excelToJson.desc': 'Chuyển đổi bảng tính Excel sang định dạng JSON. Tải lên tệp hoặc dán trực tiếp từ Excel:',
    'tool.excelToJson.uploadOrPaste': 'Tải lên hoặc Dán dữ liệu',
    'tool.excelToJson.clickToUpload': 'Nhấp để tải lên tệp Excel',
    'tool.excelToJson.fileUploaded': 'Tệp đã tải lên thành công',
    'tool.excelToJson.fileSupports': 'Hỗ trợ tệp .xlsx, .xls, .csv, .tsv',
    'tool.excelToJson.orPasteDivider': '— hoặc dán trực tiếp dữ liệu từ Excel —',
    'tool.excelToJson.pastePlaceholder': 'Sao chép các ô từ Excel và dán vào đây (Ctrl+V / Cmd+V)',
    'tool.excelToJson.convertPasted': 'Chuyển đổi dữ liệu đã dán',
    'tool.excelToJson.jsonOutput': 'Kết quả JSON',
    'tool.excelToJson.jsonOutputPlaceholder': 'Kết quả JSON sẽ hiển thị tại đây...',
    'tool.excelToJson.download': 'Tải xuống',
    'tool.excelToJson.privacy': 'Bảo mật: Tệp của bạn được xử lý hoàn toàn trong trình duyệt của bạn. Không có dữ liệu nào được tải lên máy chủ.',
    'page.notFound.title': 'Không tìm thấy trang — NUB Portal',
    'page.notFound.heading': 'Không tìm thấy trang',
    'page.notFound.pathDesc': 'Đường dẫn {path} không tồn tại.',
    'page.notFound.goHome': 'Về trang chủ',
    ...
    'tool.jwt.expired': 'Hết hạn',
    'tool.jwt.valid': 'Còn hiệu lực',
    'tool.jwt.expiresAt': 'Hết hạn lúc',
    'tool.jwt.issuedAt': 'Được cấp',
