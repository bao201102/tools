...
export const translations = {
  en: {
    ...
    'nav.item.jsonToExcel': 'JSON to Excel',
    'nav.item.excelToJson': 'Excel to JSON',
    'nav.item.yamlToJson': 'YAML to JSON',
    ...
    'home.tool.jsonToCsv.desc': 'Convert JSON data to CSV format with customizable delimiter and headers',
    'home.tool.csvToJson.title': 'CSV to JSON',
    'home.tool.csvToJson.desc': 'Convert CSV text to structured JSON array or object',
    'tool.jsonToCsv.desc': 'Paste your JSON below to convert it to CSV format:',
    'tool.csvToJson.desc': 'Paste your CSV below to convert it to JSON:',
    'home.tool.jsonToExcel.title': 'JSON to Excel',
    'home.tool.jsonToExcel.desc': 'Convert JSON data to Excel (.xlsx) spreadsheets with flattening',
    'home.tool.excelToJson.title': 'Excel to JSON',
    'home.tool.excelToJson.desc': 'Convert Excel sheets (.xlsx, .xls) or pasted table data to JSON',
    'tool.jsonToExcel.desc': 'Convert JSON arrays to Excel spreadsheets. Paste your JSON data below:',
    'tool.excelToJson.desc': 'Convert Excel spreadsheets to JSON format. Upload a file or paste directly from Excel:',
    'home.tool.yamlToJson.title': 'YAML to JSON',
    'home.tool.yamlToJson.desc': 'Convert YAML format to JSON format with syntax validation',
    'tool.yamlToJson.desc': 'Paste your YAML below to convert it to JSON:',
    ...
    'home.dash.vps.title': 'VPS Monitoring',
    ...
    'tool.json.searchFields': 'Search fields…',
    'tool.json.noFieldsFound': 'No matching fields found',
    ...
    'tool.diff.stats.linesAdded': 'lines added',
    'tool.diff.stats.linesRemoved': 'lines removed',
    'tool.diff.stats.blocks': '{count} block(s) changed',
    'tool.diff.stats.noChanges': 'No differences',
    'tool.diff.nav.prev': 'Prev',
    'tool.diff.nav.next': 'Next',
    'tool.diff.nav.prevTitle': 'Go to previous change (↑)',
    'tool.diff.nav.nextTitle': 'Go to next change (↓)',
    'tool.diff.opt.hideUnchanged': 'Collapse unchanged',
    'tool.diff.opt.showAll': 'Show all lines',
    'tool.diff.opt.hideUnchangedTitle': 'Hide unchanged lines to focus on differences',
    'tool.diff.opt.showAllTitle': 'Show all lines including unchanged',
    'tool.diff.opt.ignoreWhitespace': 'Ignore whitespace',
    'tool.diff.opt.ignoreWhitespaceTitle': 'Ignore leading/trailing whitespace differences',
    'tool.diff.opt.showWhitespace': 'Show whitespace',
    'tool.diff.opt.showWhitespaceTitle': 'Show whitespace differences',
    ...
    // Letter Counter
    'nav.item.letterCount': 'Letter Counter',
    'home.tool.letterCount.title': 'Letter Counter',
    'home.tool.letterCount.desc': 'Count characters, words, sentences, paragraphs, and analyze density in real-time.',
    'tool.letterCount.title': 'Letter Counter',
    'tool.letterCount.desc': 'Paste or type your text below to count characters, words, sentences, and perform text formatting in real-time.',
    'tool.letterCount.input': 'Input Text',
    'tool.letterCount.stats.chars': 'Characters',
    'tool.letterCount.stats.charsNoSpaces': 'Characters (no spaces)',
    'tool.letterCount.stats.words': 'Words',
    'tool.letterCount.stats.sentences': 'Sentences',
    'tool.letterCount.stats.paragraphs': 'Paragraphs',
    'tool.letterCount.stats.lines': 'Lines',
    'tool.letterCount.stats.readingTime': 'Est. Reading Time',
    'tool.letterCount.stats.speakingTime': 'Est. Speaking Time',
    'tool.letterCount.density.chars': 'Top Characters',
    'tool.letterCount.density.words': 'Top Words',
    'tool.letterCount.density.rank': 'Rank',
    'tool.letterCount.density.item': 'Character / Word',
    'tool.letterCount.density.count': 'Count',
    'tool.letterCount.density.percent': 'Percentage',
    'tool.letterCount.actions.uppercase': 'UPPERCASE',
    'tool.letterCount.actions.lowercase': 'lowercase',
    'tool.letterCount.actions.titlecase': 'Title Case',
    'tool.letterCount.actions.sentencecase': 'Sentence case',
    'tool.letterCount.placeholder': 'Start typing or paste your text here to begin analysis...',
    'tool.letterCount.sample': 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
  },
  vi: {
    // Shell / navigation
    'nav.menu': 'Menu',
    ...
    'nav.item.jsonToExcel': 'JSON sang Excel',
    'nav.item.excelToJson': 'Excel sang JSON',
    'nav.item.yamlToJson': 'YAML sang JSON',
    ...
    'home.tool.jsonToCsv.desc': 'Chuyển đổi dữ liệu định dạng JSON sang CSV',
    'home.tool.csvToJson.title': 'CSV sang JSON',
    'home.tool.csvToJson.desc': 'Chuyển đổi dữ liệu định dạng CSV sang JSON',
    'tool.jsonToCsv.desc': 'Dán JSON của bạn vào bên dưới để chuyển đổi sang định dạng CSV:',
    'tool.csvToJson.desc': 'Dán CSV của bạn vào bên dưới để chuyển đổi sang JSON:',
    'home.tool.jsonToExcel.title': 'JSON sang Excel',
    'home.tool.jsonToExcel.desc': 'Chuyển đổi dữ liệu định dạng JSON sang Excel (.xlsx)',
    'home.tool.excelToJson.title': 'Excel sang JSON',
    'home.tool.excelToJson.desc': 'Chuyển đổi tệp Excel (.xlsx, .xls) hoặc bảng tính đã sao chép sang JSON',
    'tool.jsonToExcel.desc': 'Chuyển đổi mảng JSON thành bảng tính Excel. Dán dữ liệu JSON ở bên dưới:',
    'tool.excelToJson.desc': 'Chuyển đổi bảng tính Excel sang định dạng JSON. Tải lên tệp hoặc dán trực tiếp từ Excel:',
    'home.tool.yamlToJson.title': 'YAML sang JSON',
    'home.tool.yamlToJson.desc': 'Chuyển đổi dữ liệu định dạng YAML sang JSON',
    'tool.yamlToJson.desc': 'Dán YAML của bạn vào bên dưới để chuyển đổi sang JSON:',
    ...
    'home.dash.vps.title': 'Giám sát VPS',
    ...
    'tool.json.searchFields': 'Tìm kiếm trường…',
    'tool.json.noFieldsFound': 'Không tìm thấy trường nào phù hợp',
    ...
    'tool.diff.stats.linesAdded': 'dòng thêm',
    'tool.diff.stats.linesRemoved': 'dòng xóa',
    'tool.diff.stats.blocks': '{count} block thay đổi',
    'tool.diff.stats.noChanges': 'Không có thay đổi',
    'tool.diff.nav.prev': 'Trước',
    'tool.diff.nav.next': 'Tiếp',
    'tool.diff.nav.prevTitle': 'Đến thay đổi trước (↑)',
    'tool.diff.nav.nextTitle': 'Đến thay đổi tiếp theo (↓)',
    'tool.diff.opt.hideUnchanged': 'Ẩn phần giống nhau',
    'tool.diff.opt.showAll': 'Hiển thị tất cả',
    'tool.diff.opt.hideUnchangedTitle': 'Ẩn các dòng không thay đổi để tập trung vào sự khác biệt',
    'tool.diff.opt.showAllTitle': 'Hiển thị tất cả các dòng bao gồm cả phần giống nhau',
    'tool.diff.opt.ignoreWhitespace': 'Bỏ qua khoảng trắng',
    'tool.diff.opt.ignoreWhitespaceTitle': 'Bỏ qua sự khác biệt về dấu cách đầu/cuối dòng',
    'tool.diff.opt.showWhitespace': 'Hiển khoảng trắng',
    'tool.diff.opt.showWhitespaceTitle': 'Hiển thị sự khác biệt về khoảng trắng',
    ...
    // Letter Counter
    'nav.item.letterCount': 'Đếm ký tự',
    'home.tool.letterCount.title': 'Đếm ký tự',
    'home.tool.letterCount.desc': 'Đếm ký tự, từ, dòng, đoạn văn và phân tích mật độ từ khóa thời gian thực.',
    'tool.letterCount.title': 'Bộ đếm ký tự',
    'tool.letterCount.desc': 'Dán hoặc nhập văn bản của bạn ở bên dưới để đếm ký tự, từ, câu và định dạng văn bản trực tiếp.',
    'tool.letterCount.input': 'Văn bản đầu vào',
    'tool.letterCount.stats.chars': 'Ký tự',
    'tool.letterCount.stats.charsNoSpaces': 'Ký tự (không khoảng trắng)',
    'tool.letterCount.stats.words': 'Từ',
    'tool.letterCount.stats.sentences': 'Câu',
    'tool.letterCount.stats.paragraphs': 'Đoạn văn',
    'tool.letterCount.stats.lines': 'Dòng',
    'tool.letterCount.stats.readingTime': 'Thời gian đọc ước tính',
    'tool.letterCount.stats.speakingTime': 'Thời gian nói ước tính',
    'tool.letterCount.density.chars': 'Ký tự phổ biến nhất',
    'tool.letterCount.density.words': 'Từ phổ biến nhất',
    'tool.letterCount.density.rank': 'Hạng',
    'tool.letterCount.density.item': 'Ký tự / Từ',
    'tool.letterCount.density.count': 'Số lượng',
    'tool.letterCount.density.percent': 'Tỷ lệ %',
    'tool.letterCount.actions.uppercase': 'CHỮ HOA',
    'tool.letterCount.actions.lowercase': 'chữ thường',
    'tool.letterCount.actions.titlecase': 'Viết Hoa Chữ Đầu',
    'tool.letterCount.actions.sentencecase': 'Viết hoa đầu câu',
    'tool.letterCount.placeholder': 'Bắt đầu nhập hoặc dán văn bản của bạn ở đây để phân tích...',
    'tool.letterCount.sample': 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
  },
